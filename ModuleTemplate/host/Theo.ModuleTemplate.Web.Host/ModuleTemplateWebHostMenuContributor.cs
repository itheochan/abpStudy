...
public class ModuleTemplateWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ModuleTemplateWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<ModuleTemplateResource>();
